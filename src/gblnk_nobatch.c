...
/* 
    ...
    Removing Allegro (C) 2014 Difegue
...
int main(int argc, char **argv)
	...
	/*  initialize our temporary bitmap to 8 bit 
		...
		Since GBC Pictures only use shades of gray, there's no need to keep 3 variables for r, g and b! 
	*/
	int picture [160][144];
	...
	do 	
		...
		/* progress meter */
		if (ui2 == 160) {printf("."); ui2 = 0;} else ui2++;
